...
window.onload = function() {
  // Proteksi: jika tidak ada token, redirect ke login
  ...
  // Ambil data user dari localStorage (saat login sudah disimpan)
  ...
  if (userInfo) {
    if (user && user.name) {
      ...
      userInfo.innerHTML = `<h4>Selamat datang, User!</h4>`;
    }
  }
  ...
  if (!bars || !line) {
    alert("Canvas chart-bars atau chart-line tidak ditemukan");
    return;
  }
